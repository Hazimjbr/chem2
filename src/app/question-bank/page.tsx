    ...
    useEffect(() => {
        const loadQuestions = async () => {
            ...
            const examModulesMap = {
                ...
                '/materials/semester-1/unit-2/lesson-2/part-1': () => import('@/app/materials/semester-1/unit-2/lesson-2/part-1/exam'),
                '/materials/semester-1/unit-2/lesson-2/part-2': () => import('@/app/materials/semester-1/unit-2/lesson-2/part-2/exam'),
            };
