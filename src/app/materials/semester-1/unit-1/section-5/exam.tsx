...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    }
    {
        ...
        options: [
            ...
            <InlineMath math="n_{Xe} = 15 n_{Ne}" />
            <InlineMath math="n_{Ne} = 15 n_{Xe}" />
            <InlineMath math="n_{Xe} = 05 n_{Ne}" />
        ]
        correctAnswerIndex: 1
        explanation: "وفقًا لقانون أفوجادرو يتناسب الحجم طرديًا مع عدد المولات (V/n = k) عند ثبات الضغط والحرارة V_Ne / n_Ne = V_Xe / n_Xe بالتعويض 2 / n_Ne = 3 / n_Xe بإعادة ترتيب المعادلة نحصل على n_Xe = (3/2) * n_Ne أي n_Xe = 15n_Ne"
    }
     {
        question: <span>وعاءان منفصلان لهما نفس الضغط ودرجة الحرارة الأول حجمه <span dir="ltr">2L</span> ويحتوي على <span dir="ltr"><InlineMath math="04\text{mol}"/></span> من غاز النيون <span dir="ltr">(Ne)</span> فإذا كان حجم الوعاء الثاني <span dir="ltr">3L</span> فما عدد مولات غاز الزينون <span dir="ltr">(Xe)</span> الذي يحتويه</span>
        options: [
            "04mol"
            "06mol"
            "027mol"
        ...
        correctAnswerIndex: 1
        explanation: "وفقًا لقانون أفوجادرو فإن النسبة بين الحجم وعدد المولات ثابتة للغازات عند نفس الضغط والحرارة (V₁/n₁ = V₂/n₂) يمكننا حساب عدد مولات الزينون n₂ = (V₂ × n₁) / V₁ = (3L × 04mol) / 2L = 06mol"
    }
    {
...
export const staticQuizLvl3: QuizQuestion[] = [
    {
        question: (
             <>
                <span>الضغط البخاري لنونان (<span dir="ltr" className="font-mono"><InlineMath math="CH₃(CH₂)₇CH₃"/></span>) أقل من 33-ثنائي إيثيل بنتان (<span dir="ltr" className="font-mono"><InlineMath math="C(CH₂CH₃)₄"/></span>) لأن نونان:</span>
            </>
        )
        options: [
            "أقل تفرعات"
