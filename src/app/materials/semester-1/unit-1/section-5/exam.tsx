...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    {
        question: "أي من العبارات التالية تعتبر مقارنة صحيحة بين الرابطة الفلزية والرابطة الأيونية؟",
        options: [
            "كلاهما يعتمد على وجود إلكترونات حرة الحركة",
            "الرابطة الفلزية توجد في المركبات، بينما الأيونية توجد في العناصر",
            "الرابطة الأيونية تجعل المادة قابلة للطرق، بينما الفلزية تجعلها هشة",
            "الرابطة الفلزية هي تجاذب بين أيونات موجبة وبحر إلكترونات، بينما الأيونية هي تجاذب بين أيونات موجبة وسالبة"
        ],
        correctAnswerIndex: 3,
        explanation: "هذا هو الفرق الجوهري؛ الرابطة الفلزية تنشأ في الفلزات وتتضمن بحرًا من الإلكترونات، بينما الرابطة الأيونية تنشأ بين فلز ولا فلز وتتضمن تجاذبًا بين أيونات موجبة وأيونات سالبة ثابتة في أماكنها."
    }
];
