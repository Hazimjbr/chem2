...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    },
    {
        ...
        "explanation": "الظروف المعيارية هي T₁=273K, P₁=1atm و V₁=1L الظروف الجديدة T₂=273K, P₂=2atm و V₂ = (P₁V₁T₂)/(P₂T₁) = (1*1*273)/(2*273) = 0.5L (هذا تطبيق لقانون بويل حيث الحرارة ثابتة)"
    },
    {
...
export const staticQuizLvl3: QuizQuestion[] = [
    ...
    {
        "question": "عند أي درجة حرارة بالسيليزيوس سيشغل 1.0 مول من غاز حجم 22.4 لتر عند ضغط 2.0 atm (علما بأنه عند STP يشغل 1 مول 22.4 لتر عند 1 atm و 0°C)",
        "options": [
            "0°C",
            "273°C",
            "546°C",
