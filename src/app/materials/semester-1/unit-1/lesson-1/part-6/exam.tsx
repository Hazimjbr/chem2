...
export const staticQuizLvl1: QuizQuestion[] = [
    {
        ...
        "options": [
            ...
            "العلاقة بين الضغط، الحجم، ودرجة الحرارة",
    ...
    },
    {
        ...
        "explanation": "الصيغة الصحيحة هي (P₁V₁)/T₁ = (P₂V₂)/T₂، وتعني أن حاصل ضرب الضغط في الحجم مقسومًا على درجة الحرارة المطلقة يساوي قيمة ثابتة."
    },
    {
        ...
        "explanation": "الظروف المعيارية هي T₁=273K, P₁=1atm. V₁=1L. الظروف الجديدة T₂=273K, P₂=2atm. V₂ = (P₁V₁T₂)/(P₂T₁) = (1*1*273)/(2*273) = 0.5L. (هذا تطبيق لقانون بويل حيث الحرارة ثابتة)."
    },
    {
...
export const staticQuizLvl2: QuizQuestion[] = [
     {
        ...
        "options": [
            <span><InlineMath math="1.5 P_1" /></span>,
            <span><InlineMath math="0.67 P_1" /></span>,
            <span><InlineMath math="6 P_1" /></span>,
            <span><InlineMath math="0.17 P_1" /></span>
        ],
        "correctAnswerIndex": 0,
    ...
    },
    {
        ...
        "correctAnswerIndex": 0,
        "explanation": "بما أن الحجم ثابت، يمكن استخدام قانون جاي-لوساك. T₁ = 0+273=273K. P₁=0.3atm, P₂=0.6atm. T₂ = T₁P₂/P₁ = 273 * (0.6/0.3) = 546K. مقدار التغير = T₂ - T₁ = 546K - 273K = 273K. التغير بالكلفن يساوي التغير بالسيليزيوس، لذا الجواب +273°C."
    }
];
...
export const staticQuizLvl3: QuizQuestion[] = [
    {
        ...
        "correctAnswerIndex": 0,
        "explanation": "T₁=27+273=300K, T₂=-23+273=250K. P₁=1atm, V₁=300L, P₂=0.5atm. V₂ = (P₁V₁T₂)/(P₂T₁) = (1 * 300 * 250) / (0.5 * 300) = 500L."
    },
    {
        "question": "عند أي درجة حرارة بالسيليزيوس، سيشغل 1.0 مول من غاز حجم 22.4 لتر عند ضغط 2.0 atm؟ (علما بأنه عند STP، 1 مول يشغل 22.4 لتر عند 1 atm و 0°C)",
        "options": [
            "0°C",
            "273°C",
            "546°C",
        ...
        "correctAnswerIndex": 1,
        "explanation": "الحالة 1 (STP): P₁=1atm, V₁=22.4L, T₁=273K. الحالة 2: P₂=2atm, V₂=22.4L. نجد T₂. T₂ = (P₂V₂T₁)/(P₁V₁) = (2 * 22.4 * 273) / (1 * 22.4) = 546K. بالسيليزيوس: 546 - 273 = 273°C."
    },
    {
