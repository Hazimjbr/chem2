...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    {
        "question": "وعاء يحتوي على 2 مول من غاز حجمه 10 لتر إذا أضفنا 2 مول أخرى من نفس الغاز عند نفس الظروف فما هو الحجم الجديد",
        "options": [
            "10L",
            "20L",
            "5L",
        ...
        "correctAnswerIndex": 1,
        "explanation": "وفقًا لقانون أفوجادرو يتناسب الحجم طرديًا مع عدد المولات عند مضاعفة عدد المولات من 2 إلى 4 يتضاعف الحجم أيضًا من 10 لتر إلى 20 لتر"
    },
    {
