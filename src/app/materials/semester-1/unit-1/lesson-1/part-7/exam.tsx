...
export const staticQuizLvl3: QuizQuestion[] = [
    ...
    {
        "question": <>عينة من غاز ثنائي الذرة كتلته المولية <InlineMath math="4\text{g/mol}" />. ما هي الكتلة المولية للذرة الواحدة من هذا العنصر؟</>,
        "options": [
            "2g/mol",
            "0.5g/mol",
            "8g/mol",
        ...
        "correctAnswerIndex": 0,
        "explanation": "الغاز ثنائي الذرة (X₂)، كتلته المولية هي 4g/mol. هذا يعني أن 2 × (الكتلة المولية للذرة X) = 4. إذن، الكتلة المولية للذرة الواحدة هي 4 / 2 = 2g/mol."
    },
    {
