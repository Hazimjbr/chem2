...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    },
    {
        ...
        "explanation": "الحجم المولي لأي غاز مثالي في الظروف المعيارية (0°C و 1 atm) هو قيمة ثابتة وتساوي 22.4L"
    },
    {
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation": "وفقًا لقانون أفوجادرو يتناسب الحجم طرديًا مع عدد المولات عند مضاعفة عدد المولات من 2 إلى 4 يتضاعف الحجم أيضًا من 10L إلى 20L"
    },
    {
        "question": "عند نفخ بالون يزداد حجمه أي قانون يفسر هذه الظاهرة بشكل مباشر",
        "options": [
            "قانون بويل",
            "قانون شارل",
            "قانون أفوجادرو",
        ...
        "correctAnswerIndex": 2,
        "explanation": "نفخ البالون يعني زيادة كمية الهواء (عدد المولات) بداخله مما يؤدي إلى زيادة الحجم عند ثبات الضغط والحرارة تقريبًا وهذا هو نص قانون أفوجادرو"
    }
];
...
export const staticQuizLvl3: QuizQuestion[] = [
    ...
    {
        question: <>عينة من غاز الميثان في الظروف المعيارية حجمها <InlineMath math="3L" /> إذا علمت أن الكتلة المولية للميثان <InlineMath math="16\text{g/mol}" /> فإن عدد جزيئات الميثان يساوي</>,
        "options": [
            "8.06x10²²",
            "6.02x10²³",
            "8x10²³",
