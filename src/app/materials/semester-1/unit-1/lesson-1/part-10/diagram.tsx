...
export const DiffusionProcessDiagram = (props: Partial<SVGProps<SVGSVGElement>>) => (
    <SvgDiagram viewBox="0 0 450 360" {...props}>
        ...
        <use href="#white-diatomic" x="250" y="115" /> 
        <use href="#white-diatomic" x="280" y="155" /> 
        <use href="#black-diatomic" x="350" y="110" /> 
        <use href="#black-diatomic" x="380" y="160" />
        ...
        <use href="#black-diatomic" x="260" y="215" /> 
        <use href="#black-diatomic" x="290" y="245" />
        <use href="#white-diatomic" x="350" y="200" /> 
        <use href="#white-diatomic" x="380" y="230" />
...
export const AmmoniumChlorideDiagram = (props: Partial<SVGProps<SVGSVGElement>>) => (
     <SvgDiagram viewBox="0 0 450 100" {...props}>
        ...
        <text x="420" y="80" textAnchor="middle" fontSize="10">قطن مبلل بـ NH₃</text>
