...
export const staticQuizLvl1: QuizQuestion[] = [
    {
        "question": "العبارة التي تتفق مع قانون بويل:",
        "options": [
            "زيادة الضغط تقلل من حجم الغاز",
            "نقصان الحرارة تقلل من ضغط الغاز",
            "زيادة عدد مولات الغاز تزيد الضغط",
            "نقصان الحجم تقلل من ضغط الغاز"
        ],
        "correctAnswerIndex": 0,
        "explanation": "قانون بويل يصف العلاقة العكسية بين الضغط والحجم عند ثبات درجة الحرارة وكمية الغاز لذلك زيادة الضغط تؤدي إلى نقصان الحجم"
    },
    {
