...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    {
        "question": "منطاد يحتوي على 30 لترًا من غاز الهيليوم عند ضغط 103kPa. إذا ارتفع المنطاد إلى ارتفاع حيث يصبح الضغط 25kPa (مع ثبات الحرارة)، فما هو الحجم الجديد للهيليوم؟",
        "options": [
            "7.28L",
            "123.6L",
            "30L",
...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    {
        "question": "عينة من غاز الأكسجين حجمها 4.5 لتر عند ضغط 760mmHg. إذا تم تغيير الحجم إلى 9 لترات عند درجة حرارة ثابتة، فما هو الضغط الجديد بوحدة mmHg؟",
        "options": [
            "1520mmHg",
            "760mmHg",
            "380mmHg",
