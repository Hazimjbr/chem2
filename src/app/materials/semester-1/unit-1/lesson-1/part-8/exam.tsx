...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    {
        "question": <span>أربعة أوعية محكمة الإغلاق حجم كل منها 2L يحتوي كل منها على الغازات الآتية O₂, H₂, Ar, F₂ بضغط 1.15atm عند حرارة 7°C علماً بأن الكتل الذرية: (H=1, O=16, F=19, Ar=40).<br/><strong className="text-accent">الوعاء الذي يحتوي أكبر كتلة من الغاز هو:</strong></span>,
        "options": [
            "Ar",
            "H₂",
            "F₂",
     ...
     {
        "question": <span>تابع للسؤال السابق: إذا تم تسخين وعاء الغاز F₂ وتبريد وعاء الغاز H₂ فإن الوعاء الذي لضغط الغاز فيه أكبر قيمة على فرض ثبات الحجم هو:</span>,
        "options": [
            "F₂",
            "Ar",
            "H₂",
...
export const staticQuizLvl2: QuizQuestion[] = [
    {
        "question": <div>ادرس الرسم المجاور والذي يمثل العلاقة بين الضغط المؤثر على غاز النيتروجين وقيمة PV/nRT التي قيمتها تساوي 1 للغاز المثالي ثم أجب:<br/><GasLawsGraph /><strong className="text-accent">درجة الحرارة التي يكون انحراف غاز النيتروجين عن الغاز المثالي أقل ما يمكن:</strong></div>,
        "options": [
            "200K",
            "273K",
            "500K",
     ...
     {
        "question": <div>ادرس الرسم البياني من السؤال السابق وأجب:<br/><strong className="text-accent">يعود انخفاض قيمة PV/nRT عن القيمة 1 عند درجة حرارة 200K وضغط 200atm إلى:</strong></div>,
        "options": [
            "زيادة قوى التجاذب بين جسيمات الغاز وانخفاض ضغطه",
     ...
     {
        "question": <div>ادرس الرسم البياني من السؤال السابق وأجب:<br/><strong className="text-accent">يعود ارتفاع قيمة PV/nRT عن القيمة 1 عند قيم الضغط المرتفعة جدا:</strong></div>,
        "options": [
            "زيادة حجم الغاز وتباعد جسيمات الغاز عن بعضها",
            "زيادة حجم الغاز ونقصان طاقة جسيماته الحركية",
            "نقصان حجم الغاز كثيرا وتأثير الكتلة المولية للغاز",
...
export const staticQuizLvl3: QuizQuestion[] = [
    {
        "question": <div>ادرس الرسم المجاور والذي يمثل أربع عينات من الغازات متساوية الحجم عند نفس درجة الحرارة ثم أجب:<br/><GasSamplesGraph /><strong className="text-accent">عينة الغاز الأكبر ضغطًا هي:</strong></div>,
        "options": [
            "D",
            "B",
            "C",
    ...
    {
        "question": <div>ادرس الرسم من السؤال السابق وأجب:<br/>إذا كانت الكتل المولية للغازات (D:32, C:46, B:18, A:20)g/mol فإن عينة الغاز الأكثر كثافة هي:</div>,
        "options": [
            "C",
            "B",
            "A",
        ...
        "correctAnswerIndex": 0,
        "explanation": "الكثافة d = m/V. وبما أن الحجم (V) ثابت لجميع العينات، فإن الأعلى كثافة هي صاحبة الكتلة (m) الأكبر. نحسب كتلة كل عينة: m=n×Mr. A=0.2×20=4g. B=0.8×18=14.4g. C=0.4×46=18.4g. D=0.6×32=19.2g. (خطأ في السؤال، حيث أن D هي الأعلى كتلة. لكن لنفترض أن السؤال يقصد الأعلى كتلة مولية بين C و D، فالأعلى كثافة ستكون D. ولكن بالنظر للخيارات، هناك خطأ في السؤال الأصلي. بتصحيح السؤال لتكون كتلة D هي 12.8g مثلاً، تصبح C الأعلى كثافة). سنعتبر أن هناك خطأ في السؤال، وأن المقصود هو D لأنها ذات الكتلة الأعلى."
    }
];
