...
export const staticQuizLvl1: QuizQuestion[] = [
    ...
    {
        "question": "أربعة أوعية محكمة الإغلاق حجم كل منها 2L يحتوي كل منها على غازات بضغط 1.15atm عند حرارة 7°C. أي وعاء يحتوي على أكبر كتلة من الغاز؟ (الكتل المولية: H=1, O=16, F=19, Ar=40)",
        "options": [
            "Ar",
            "H₂",
            "F₂",
    ...
    {
        "question": <div>أربعة أوعية محكمة الإغلاق حجم كل منها 2L يحتوي كل منها على غازات بضغط 1.15atm عند حرارة 7°C. إذا تم تسخين وعاء الغاز F₂ وتبريد وعاء الغاز H₂، فأي وعاء سيكون ضغط الغاز فيه هو الأعلى؟</div>,
        "options": [
            "F₂",
            "Ar",
            "H₂",
    ...
    {
        question: <div><p>ادرس الرسم البياني الذي يمثل أربع عينات من الغازات متساوية الحجم عند نفس درجة الحرارة ثم أجب:</p><GasSamplesGraph /><strong className="text-accent">أي عينة غاز لها الضغط الأكبر؟</strong></div>,
        "options": [
            "D",
            "B",
            "C",
    ...
    {
        question: <div><p>ادرس الرسم البياني للغازات من السؤال السابق، إذا كانت الكتل المولية للغازات (D:32, C:46, B:18, A:20)g/mol، فأي عينة هي الأكثر كثافة؟</p></div>,
        "options": [
            "C",
            "B",
            "A",
...
export const staticQuizLvl2: QuizQuestion[] = [
    {
     ...
     {
        question: <div><p>ادرس الرسم البياني من السؤال السابق وأجب:</p><strong className="text-accent mt-2 block">ما سبب انخفاض قيمة PV/nRT عن 1 عند درجة حرارة 200K وضغط 200atm؟</strong></div>,
        "options": [
     ...
     {
        question: <div><p>ادرس الرسم البياني من السؤال السابق وأجب:</p><strong className="text-accent mt-2 block">ما سبب ارتفاع قيمة PV/nRT عن 1 عند قيم الضغط المرتفعة جدًا؟</strong></div>,
        "options": [
