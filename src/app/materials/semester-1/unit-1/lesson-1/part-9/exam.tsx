...
const mainQuestionLvl3 = <><span>إذا خلط </span><span dir="ltr" className="inline-block"><InlineMath math="0.5L" /></span><span> من غاز A ضغطه </span><span dir="ltr" className="inline-block"><InlineMath math="300mmHg" /></span><span> درجة حرارته </span><span dir="ltr" className="inline-block"><InlineMath math="300K" /></span><span> مع </span><span dir="ltr" className="inline-block"><InlineMath math="0.43L" /></span><span> من غاز B له نفس الحرارة ضغطه </span><span dir="ltr" className="inline-block"><InlineMath math="350mmHg" /></span><span> فكان الضغط الكلي للخليط داخل الوعاء W يساوي </span><span dir="ltr" className="inline-block"><InlineMath math="500mmHg" /></span><span> عند نفس درجة الحرارة.</span></>
...
export const staticQuizLvl2: QuizQuestion[] = [
    {
        "question": <span>يحتوي وعاء حجمه <InlineMath math="1.5L" /> غازين A, B عند حرارة <InlineMath math="10^\circ \text{C}" /> حيث يشكل الغاز B 70%. إذا كان ضغط الوعاء يساوي <InlineMath math="2.5atm" /> فإن عدد مولات الغاز A تساوي:</span>,
        "options": [
            "1.4",
            "0.11",
            "0.16",
