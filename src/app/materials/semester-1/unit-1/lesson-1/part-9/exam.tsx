...
export const staticQuizLvl3: QuizQuestion[] = [
    {
        question: <span>إذا خلط <InlineMath math="0.5L" /> من غاز A ضغطه <InlineMath math="300mmHg" /> درجة حرارته <InlineMath math="300K" /> مع <InlineMath math="0.43L" /> من غاز B له نفس الحرارة ضغطه <InlineMath math="350mmHg" /> فكان الضغط الكلي للخليط داخل الوعاء W يساوي <InlineMath math="500mmHg" /> عند نفس درجة الحرارة. أجب عن الأسئلة الخمسة الآتية: <br/> 1) عدد مولات الغاز A:</span>,
        "options": [
            "0.016",
            "0.008",
            "0.004",
