...
export const staticQuizLvl1: QuizQuestion[] = [
    {
        ...
        "explanation": "نظرية الحركة الجزيئية تفترض أن جسيمات الغاز في حركة مستمرة وعشوائية وسريعة في جميع الاتجاهات وفي خطوط مستقيمة حتى تصطدم بجسيم آخر أو بجدار الوعاء"
    },
    {
    ...
    },
    {
        ...
        "correctAnswerIndex": 3,
        "explanation": "العبارة التي تنص على أن الطاقة الحركية لجميع الجزيئات متساوية هي الخاطئة. عند درجة حرارة معينة، تمتلك جسيمات الغاز توزيعًا من السرعات والطاقات الحركية المختلفة، ولكن متوسط هذه الطاقة الحركية هو الذي يكون ثابتًا ويتناسب مع درجة الحرارة المطلقة."
    },
    {
...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    },
    {
        ...
        "options": [
            "يعتبر تفاعل الهيدروجين مع الكلور لتكوين كلوريد الهيدروجين تصادما مرنا",
        ...
        "correctAnswerIndex": 3,
        "explanation": "العبارة التي تصف نشوء ضغط الغاز صحيحة. باقي العبارات خاطئة: التفاعلات الكيميائية ليست تصادمات مرنة، الجسيمات تتحرك في خطوط مستقيمة، والغاز الحقيقي يقترب من المثالي عند ضغط منخفض وحرارة مرتفعة."
    },
    {
    ...
    },
    {
        ...
        "correctAnswerIndex": 1,
        "explanation": "في التصادم المرن قد تنتقل الطاقة الحركية بين الجسيمات لكن الطاقة الحركية الكلية للنظام تبقى ثابتة الطاقة الكلية قبل التصادم هي 40 + 50 = 90. الخيار الوحيد الذي يكون فيه مجموع الطاقات بعد التصادم يساوي 90 هو (60 + 30 = 90)."
    }
];
