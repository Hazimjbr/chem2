            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                    <div className="space-y-3 text-sm">
                        ...
                        <div>
                            <p>‌ب) ترتبط الطبقات فيما بينها بقوى لندن الضعيفة (روابط π) على شكل إلكترونات حرة الحركة لذلك يكون:</p>
                             <ol className="list-decimal mr-6 mt-2 text-xs text-muted-foreground space-y-1">
