...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    },
    {
        "question": (
            <>
                <p>اعتمادا على الرسم المجاور والذي يمثل العلاقة بين درجة الحرارة °C والضغط البخاري mmHg لأربعة سوائل فإن الضغط البخاري لثنائي إيثيل إيثر C₂H₅OC₂H₅ عند درجة حرارة <span dir="ltr">30°C</span> يساوي:</p>
                <div className="flex justify-center my-4">
                    <Image
                        src="https://i.ibb.co/84T52SSm/3.png"
                        alt="منحنيات الضغط البخاري"
