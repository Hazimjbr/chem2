...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    },
    {
        ...
        correctAnswerIndex: 1,
        explanation: "من الرسم، درجة غليان (أو تكاثف) المادة A هي 70°C. بما أن درجة غليان المادة C (90°C) أعلى من A، فهذا يعني أن قوى الترابط بين جزيئات C أقوى من A، حيث يتطلب كسرها طاقة أكبر."
    },
    {
        question: (
            <div className="space-y-4">
