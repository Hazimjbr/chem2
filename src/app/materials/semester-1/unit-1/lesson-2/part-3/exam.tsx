...
export const staticQuizLvl2: QuizQuestion[] = [
    ...
    },
    {
        ...
        correctAnswerIndex: 1,
        explanation: "من الرسم درجة غليان أو تكاثف المادة A هي 70 درجة مئوية بما أن درجة غليان المادة C 90 درجة مئوية أعلى من A فهذا يعني أن قوى الترابط بين جزيئات C أقوى من A حيث يتطلب كسرها طاقة أكبر"
    },
    {
        question: (
            <div className="space-y-4">
                 <p>بالاعتماد على الرسم البياني، إذا علمت أن المادة A هي الإيثانول (<span dir="ltr">CH₃CH₂OH</span>) والمادة B هي الأسيتون (<span dir="ltr">CH₃COCH₃</span>)، فأي العبارات التالية تفسر سبب كون درجة تكاثف المادة A (70°C) أعلى؟</p>
                 <div className="flex justify-center my-4">
                     <Image
                        src="https://i.ibb.co/GfZ5wtqG/22.png"
                        alt="منحنى تبريد المادة A"
        ...
        correctAnswerIndex: 2,
        explanation: "درجة التكاثف (الغليان) تعتمد على قوة الترابط الإيثانول يكون روابط هيدروجينية قوية بين جزيئاته وهي أقوى من قوى ثنائي القطب في الأسيتون هذه الروابط القوية تتطلب فقدان أو اكتساب طاقة أكبر للتغلب عليها مما يرفع درجة التكاثف"
    }
];
