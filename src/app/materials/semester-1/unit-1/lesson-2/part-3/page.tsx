        ...
        <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <FlippableCard cardTitle="آلية التكاثف" cardIcon={<Cpu className="h-6 w-6" />}>
                     <p className="text-sm">
                        عند انخفاض درجة حرارة الغاز، تقل طاقة جزيئاته الحركية وتقل سرعتها. هذا يسمح لقوى التجاذب بأن تصبح أكثر تأثيرًا، فتتقارب الجزيئات من بعضها وتتشابك لتشكل الحالة السائلة عند درجة حرارة معينة تعرف بدرجة التكاثف (أو درجة الغليان).
                    </p>
                </FlippableCard>
                 ...
                 <FlippableCard cardTitle="طاقة التكاثف المولية" cardIcon={<Zap className="h-6 w-6" />}>
                    ...
                    <ul className="list-disc mr-4 text-xs space-y-1">
                        <li>تتساوى طاقة التكاثف المولية مع طاقة التبخر المولية في القيمة.</li>
                        <li>تختلفان في الإشارة (التكاثف طارد للطاقة، والتبخر ماص للطاقة).</li>
                    </ul>
                </FlippableCard>
