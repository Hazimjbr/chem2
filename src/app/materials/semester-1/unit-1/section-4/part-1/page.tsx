    ...
    <LessonLayout {...lessonInfo}>
        <div className="space-y-8">
            ...
            >
                <CardContent className="p-4">
                    <p>
                        تصنع الدعامات القلبية فتح الشرايين الحديثة من سبيكة التيتانيوم Ti بإضافة التنتاليوم Ta والنيوبيوم Nb بنسب 77617 وتمتاز بالقوة والمرونة وخلوها من المواد السامة أو المسببة للحساسية والالتهابات العصبية
                    </p>
                </CardContent>
            </FlippableCard>
        </div>
