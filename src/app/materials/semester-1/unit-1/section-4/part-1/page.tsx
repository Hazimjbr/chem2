    ...
    <LessonLayout {...lessonInfo}>
        <div className="space-y-8">
            ...
            >
                <CardContent>
                    <p>
                        تطلق دائرة الأرصاد الجوية من محطة المفرق بالونات الطقس (بهدف زيادة الدقة في التنبؤ الجوي) التي ترسل بيانات عناصر الطقس (حرارة، رطوبة وضغط) في طبقات الجو العليا إلى المحطات الأرضية قبل أن تنفجر على ارتفاع 27km بسبب انخفاض الضغط الكبير وتمدد الغاز.
                    </p>
                </CardContent>
            </FlippableCard>
