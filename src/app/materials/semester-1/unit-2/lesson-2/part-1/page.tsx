...
const lessonInfo = {
    ...
    mainIdea: "الخصائص الجامعة هي خصائص فيزيائية للمحاليل تعتمد على عدد جسيمات المذاب وليس على طبيعتها، وتشمل الانخفاض في الضغط البخاري، الارتفاع في درجة الغليان، الانخفاض في درجة التجمد، والضغط الأسموزي.",
    learningOutcomes: [
