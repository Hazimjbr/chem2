...
const lessonInfo = {
    ...
    lessonContent: `<p>بعد أن صنفنا المواد، سنتعمق الآن في كيفية تكون أحد أهم أنواع المخاليط وهو المحلول. سنكتشف القوى التي تحكم عملية الإذابة، ولماذا تذوب بعض المواد في بعضها بينما لا تذوب أخرى.</p>`,
            ...
            <FlippableCard cardTitle="الإذابة ومبدأ 'الشبيه يذيب شبيهه'" cardIcon={<Layers className="h-6 w-6" />}>
                <div className="p-4 space-y-4">
                    <div>
                        ...
                        <p className="text-sm mt-1">إحاطة جسيمات المذاب بجسيمات المذيب بحيث تتكون قوى تجاذب بينهما تكون كافية للتغلب على قوى التجاذب بين جسيمات المذاب نفسه</p>
                    </div>
            ...
            <FlippableCard cardTitle="آلية الإذابة" cardIcon={<Cpu className="h-6 w-6" />}>
                <div className="p-4 space-y-4 text-sm">
                    <ol className="list-decimal mr-4 space-y-3">
                        <li>
                            <p><strong>في المركبات الأيونية</strong> كملح الطعام NaCl تحيط جزيئات الماء أيونات ⁺Na من طرف ذرة الأكسجين (δ⁻) وأيونات Cl⁻ من طرف ذرة الهيدروجين (δ⁺) لينتج من ذلك قوة تجاذب بين جزيئات الماء القطبية والأيونات أقوى من قوى التجاذب بين الأيونات في البلورة فتتغلب عليها وتتحرر الأيونات من البلورة</p>
                        </li>
                        <li>
                            <p><strong>في المركبات التساهمية (الجزيئية)</strong> مثل سكر المائدة السكروز (C₆H₁₂O₆) أو الكحول كالإيثانول (CH₃CH₂OH) فيحتوي كل منها على مجموعة الهيدروكسيل OH التي تكون روابط هيدروجينية مع جزيئات الماء</p>
                        </li>
                        <li>
                            <p><strong>يذوب الزيت في البنزين</strong> لأن كليهما غير قطبيين تترابط جزيئاتهما بقوى لندن بينما لا يذوب في الماء</p>
                        </li>
                    </ol>
                </div>
            </FlippableCard>
