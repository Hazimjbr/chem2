...
const sampleQuestion = {
    ...
    "options": [
        <GraphVisual path="M 30 70 C 40 40, 60 25, 80 20" />, //  منحنى متزايد A
        <GraphVisual path="M 30 20 L 80 70" />, //  خطي متناقص B
        <GraphVisual path="M 20 80 L 85 15" />, //  خطي متزايد يمر بالاصل C (Correct)
        <GraphVisual path="M 30 20 C 40 30, 50 50, 80 75" />  // منحنى متناقص D
    ],
    "correctAnswerIndex": 2,
    "explanation": "قانون بويل هو P·V=k. يمكن إعادة ترتيبه إلى V = k * (1/P). هذه هي معادلة خط مستقيم (y = mx + c حيث c=0) بين V (المحور الصادي) و 1/P (المحور السيني). بما أن الميل (k) موجب، فإن العلاقة طردية خطية تمر بنقطة الأصل."
};
// ====================================================================================
// ====================================================================================
