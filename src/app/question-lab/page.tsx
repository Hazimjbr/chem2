...
const sampleQuestion = {
    question: <div><p>2) إذا كانت الكتل المولية للغازات (D : 32 , C : 46 , B : 20, A : 18) فإن عينة الغاز الأكثر كثافة هي</p><GasSamplesGraph /><strong className="text-accent mt-2 block">أي وعاء يحتوي على غاز له الضغط الأعلى؟</strong></div>,
    options: [
        "A",
        "B",
        "C",
