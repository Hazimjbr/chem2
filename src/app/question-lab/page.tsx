...
const newQuestion: Question | null = {
    ...
    explanation: (
         <div className="space-y-3 text-right" dir="rtl">
            <p>الضغط على سطح السائل المحصور عند النقطة A أقل من الضغط الجوي بمقدار ارتفاع عمود الزئبق</p>
            <p>الضغط الجوي المعياري يساوي 760 ملم زئبق والضغط الناتج عن ارتفاع عمود الزئبق يساوي 380 ملم زئبق</p>
            <p>لذا الضغط عند A يساوي 760 ناقص 380 ويساوي 380 ملم زئبق</p>
            <p>لتحويل الضغط من ملم زئبق إلى كيلو باسكال نستخدم العلاقة 101.3 كيلو باسكال يساوي 760 ملم زئبق</p>
            <p>إذن الضغط بالكيلو باسكال يساوي 380 مقسومًا على 760 ثم نضرب الناتج في 101.3 ليكون الناتج النهائي حوالي 50.65 كيلو باسكال</p>
            <p>بما أن الضغط الجوي المعياري يساوي 101 كيلو باسكال فإن أقرب إجابة منطقية هي هذه القيمة</p>
        </div>
    ),
    level: 3,
