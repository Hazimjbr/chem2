...
const sampleQuestion = {
    ...
    options: [
        ...
        <GraphVisual path="M 30 20 C 50 60, 60 70, 80 75" />, // منحنى أكثر انحناءً للداخل
        <GraphVisual path="M 30 20 L 80 70" />
    ],
    correctAnswerIndex: 2, // تم تحديث الإجابة الصحيحة إلى 'ج'
    explanation: "العلاقة بين حجم الغاز وضغطه عند ثبات الحرارة هي علاقة عكسية، ويمثلها المنحنى المتناقص. (الشرح تم تعديله مؤقتًا ليتوافق مع الإجابة الجديدة المختارة)"
};
// ====================================================================================
// ====================================================================================
