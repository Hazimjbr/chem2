...
const newQuestion: Question | null = {
    questionText: "درجة انصهار كل من الألماس (شبكي تساهمي) وكلوريد الصوديوم (أيوني) مرتفعة جدًا. ما هو الفرق الجوهري في سبب ارتفاع درجة الانصهار بينهما؟",
    options: [
        "الألماس يتطلب كسر روابط تساهمية قوية، بينما كلوريد الصوديوم يتطلب التغلب على قوى تجاذب كهروستاتيكي.",
        "كلاهما يتطلبان كسر روابط أيونية قوية.",
        "الألماس يتطلب التغلب على قوى لندن، بينما كلوريد الصوديوم يتطلب كسر روابط تساهمية.",
        "لا يوجد فرق جوهري، كلاهما لهما نفس سبب ارتفاع درجة الانصهار."
    ],
    correctAnswerIndex: 0,
    explanation: "الفرق الأساسي يكمن في طبيعة القوى. في الألماس، يجب كسر الروابط التساهمية القوية والمباشرة بين ذرات الكربون نفسها، وهي عملية تتطلب طاقة هائلة. أما في كلوريد الصوديوم، فإن الانصهار يتطلب التغلب على قوى التجاذب الكهروستاتيكي القوية التي تربط الأيونات الموجبة والسالبة في الشبكة البلورية، دون كسر روابط داخل الأيونات نفسها.",
    level: 3,
