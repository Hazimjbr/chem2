...
const newQuestion: Question | null = {
    ...
    explanation: "العبارة الخاطئة هي معظم جزيئات المادة C في الحالة الغازية لأن الرسم يمثل طاقة التنشيط للتبخر ولا يوضح الحالة الفيزيائية للمواد الخيار C لها أعلى ضغط بخاري صحيح لأن C لها أقل طاقة تنشيط مما يعني أضعف قوى ترابط وأعلى ضغط بخاري الخيار B لها أعلى طاقة تكاثف مولية صحيح لأن B لها أعلى طاقة تنشيط مما يعني أقوى قوى ترابط وأعلى طاقة تكاثف الخيار ترابط جزيئات المادة A أضعف من المادة D صحيح لأن طاقة تنشيط A أقل من D مما يعني أن قوى الترابط في A أضعف",
    level: 3,
