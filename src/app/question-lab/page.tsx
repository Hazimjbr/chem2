...
const newQuestion: Question | null = {
    questionText: "إذا أضيف 30g من ملح كلوريد الصوديوم NaCl إلى 50g ماء عند درجة حرارة 50°C وبعد تحريك المحلول جيدا ترسبت كمية من الملح في قاع الوعاء، تم ترشيح المحلول وتجفيف الملح المترسب فكانت كتلته 10g فإن ذائبية الملح عند هذه الدرجة تساوي:",
    options: [
        "10",
        "20",
        "40",
