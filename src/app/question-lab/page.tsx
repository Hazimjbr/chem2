...
const newQuestion: Question | null = {
    questionText: "مركبان A و B لهما نفس الكتلة المولية تقريبًا المركب A هو (CH₃OCH₃) والمركب B هو (CH₃CH₂OH) أي العبارات التالية تفسر لماذا يذوب المركب B في الماء بشكل أفضل بكثير من المركب A",
    options: [
        "لأن المركب A غير قطبي",
        "لأن قوى لندن في المركب B أقوى",
        "لأن المركب B يكون روابط هيدروجينية مع الماء بينما المركب A لا يستطيع",
        "لأن المركب A يتفاعل مع الماء"
    ],
    correctAnswerIndex: 2,
    explanation: "على الرغم من أن كلا المركبين قطبيان ولهما نفس الكتلة المولية تقريبًا إلا أن الإيثانول (B) يحتوي على مجموعة هيدروكسيل (OH) تمكنه من تكوين روابط هيدروجينية قوية مع جزيئات الماء أما الإيثر (A) فلا يمتلك هذه القدرة وقوى التجاذب (ثنائي القطب) التي يكونها مع الماء أضعف بكثير مما يجعل ذائبيته أقل",
    level: 3,
