...
const newQuestion: Question | null = {
    questionText: "عند مقارنة ذائبية الكحولات التالية في الماء، أيها الأقل ذائبية ولماذا؟",
    options: [
        "الميثانول (CH₃OH)، لأن كتلته المولية هي الأقل.",
        "الهكسانول (CH₃(CH₂)₅OH)، لأن الجزء غير القطبي (السلسلة الكربونية) هو الأكبر.",
        "الإيثانول (CH₃CH₂OH)، لأنه يمتلك قوى ثنائي قطب أضعف.",
        "البروبانول (CH₃CH₂CH₂OH)، لأن قطبيته هي الأعلى."
    ],
    correctAnswerIndex: 1,
    explanation: "جميع هذه الكحولات قطبية وتكون روابط هيدروجينية مع الماء. لكن، كلما زاد طول السلسلة الكربونية (الشق غير القطبي)، زاد تأثير الجزء الكاره للماء في الجزيء، مما يقلل من قدرته على الذوبان في الماء القطبي. الهكسانول يمتلك أطول سلسلة كربونية، لذا فهو الأقل ذائبية.",
    level: 3,
