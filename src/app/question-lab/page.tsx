            ...
            <div className="space-y-6">
                 <Card className="w-full">
                    ...
                    <CardContent className="space-y-2">
                         <Button
                            variant="outline"
                            className="w-full justify-between text-right h-auto py-2 px-3 text-sm flex items-center border-green-500 bg-green-500/10 text-green-700 hover:bg-green-500/20"
                            disabled
                        >
                         ...
                         <Button
                            variant="outline"
                            className="w-full justify-between text-right h-auto py-2 px-3 text-sm flex items-center"
                            disabled
                        >
                    ...
                    <CardFooter>
                         <Alert variant="default" className="border-blue-500 bg-blue-100/30 w-full">
                            ...
                            <AlertDescription>درجة التكاثف هي درجة الحرارة الثابتة التي يتحول عندها الغاز إلى سائل. من الرسم البياني، نلاحظ أن درجة الحرارة تثبت عند 70°C أثناء عملية التكاثف (الخط الأفقي الأول).</AlertDescription>
                        </Alert>
                    </CardFooter>
                </Card>
            </div>
