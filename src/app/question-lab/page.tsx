...
const sampleQuestion = {
    "question": <span>أسطوانة تحتوي عينة من غاز محصور حجمه (V) سخن من درجة حرارة <InlineMath math="25^\circ C" /> إلى <InlineMath math="150^\circ C" /> فإن أحد خصائص الغاز الآتية تبقى ثابتة</span>,
    "options": [
