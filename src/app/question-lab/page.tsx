...
const question = {
    ...
    explanation: "حمض الأسيتيك (CH₃COOH) هو الأقوى لأنه يكون رابطتين هيدروجينيتين لكل جزيء (دايمر)، وهي أقوى بكثير من قوى ثنائي القطب في الخيارين ب و ج، وقوى لندن في الخيار د."
}
