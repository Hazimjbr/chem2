...
const sampleQuestion = {
    question: "أي من الغازات التالية هو الأكثر انحرافاً عن السلوك المثالي عند نفس الظروف من الضغط والحرارة؟ (الكتل الذرية: H=1, O=16, F=19, Ar=40)",
    options: [
        "Ar",
        "H₂",
        "F₂",
    ...
    explanation: "يزداد الانحراف عن السلوك المثالي بزيادة قوى التجاذب، والتي تزداد بزيادة الكتلة المولية. بعد حساب الكتل المولية (Ar=40, H₂=2, F₂=38, O₂=32)، نجد أن الأرجون (Ar) له الكتلة المولية الأعلى، وبالتالي هو الأكثر انحرافًا."
};
// ====================================================================================
// ====================================================================================
