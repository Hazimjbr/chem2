...
const sampleQuestion = {
    ...
    "options": [
        ...
        <GraphVisual path="M 20 70 L 85 5" />,
        <GraphVisual path="M 30 80 C 50 50, 70 30, 85 15" />
    ],
    "correctAnswerIndex": 1,
    "explanation": "قانون بويل هو P·V=k. يمكن إعادة ترتيبه إلى V = k * (1/P). هذه هي معادلة خط مستقيم (y = mx) بين الحجم (V) على المحور الصادي، ومقلوب الضغط (1/P) على المحور السيني، ويمر الخط بنقطة الأصل."
};
// ====================================================================================
// ====================================================================================
