...
const sampleQuestion = {
    question: "تصادم جسيمان B / A تصادما مرنا فإذا كانت طاقتيهما قبل التصادم على التوالي 50 / 40 فإن طاقتيهما بعد التصادم تساوي:",
    options: [
        "45 / 55",
        "60 / 30",
        "30 / 70",
    ...
    explanation: "في التصادم المرن، قد تنتقل الطاقة الحركية بين الجسيمات، لكن الطاقة الحركية الكلية للنظام تبقى ثابتة. الطاقة الكلية قبل التصادم هي 40 + 50 = 90. الخيار الوحيد الذي يكون فيه مجموع الطاقات بعد التصادم يساوي 90 هو الخيار (ب) (60 + 30 = 90)."
};
// ====================================================================================
// ====================================================================================
