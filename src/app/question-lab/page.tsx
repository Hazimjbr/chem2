...
const newQuestion: Question | null = {
    ...
    explanation: <>في أواني الضغط، يؤدي الضغط المرتفع إلى رفع درجة غليان الماء فوق <span dir="ltr">100°C</span>. الطهي عند درجة حرارة أعلى يسرّع من التفاعلات الكيميائية المسؤولة عن نضج الطعام، مما يقلل من وقت الطهي بشكل ملحوظ.</>,
    level: 1,
