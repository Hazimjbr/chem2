...
const sampleQuestion = {
    question: <span>بالون درجة حرارته المطلقة 796K إذا تغيرت لتصبح 125°C فإن العبارة الصحيحة التي تصف هذا التغير هي:</span>,
    options: ["زادت إلى الضعف", "قلت إلى النصف", "زادت خمسة أضعاف", "قلت إلى الخمس"],
    correctAnswerIndex: 1,
    explanation: "أولاً، نوحد وحدات درجة الحرارة. الحرارة النهائية T₂ = 125 + 273 = 398K. الحرارة الابتدائية T₁ = 796K. نلاحظ أن الحرارة النهائية (398K) هي نصف الحرارة الابتدائية (796K)، لذا فإنها قلت إلى النصف."
};
// ====================================================================================
// ====================================================================================
