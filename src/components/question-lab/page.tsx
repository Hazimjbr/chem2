...
const newQuestion: Question | null = {
    ...
    explanation: <>من خلال تتبع الخط العمودي من درجة حرارة <span dir="ltr">30°C</span> حتى يتقاطع مع منحنى ثنائي إيثيل إيثر ثم التحرك أفقيًا إلى محور الضغط نجد أن القيمة تقارب 650mmHg</>,
    level: 2,
