...
const newQuestion: Question | null = {
    questionText: (
        <>
            <p>اعتمادا على الرسم المجاور والذي يمثل العلاقة بين درجة الحرارة <span dir="ltr" className="inline-block"><InlineMath math="^\circ\text{C}"/></span> والضغط البخاري mmHg لأربعة سوائل فإن الضغط البخاري لثنائي إيثيل إيثر C2H5OC2H5 عند <span dir="ltr" className="inline-block"><InlineMath math="30^\circ\text{C}"/></span> يساوي</p>
    ...
    explanation: <>من خلال تتبع الخط العمودي من درجة حرارة <span dir="ltr" className="inline-block"><InlineMath math="30^\circ\text{C}" /></span> حتى يتقاطع مع منحنى ثنائي إيثيل إيثر ثم التحرك أفقيًا إلى محور الضغط نجد أن القيمة تقارب 650mmHg</>,
    level: 2,
