...
const newQuestion: Question | null = {
    ...
    explanation: "أعلى درجة غليان تعني أقوى قوى ترابط وأقل ضغط بخاري. من الرسم، الماء (المنحنى D) له أقل ضغط بخاري عند أي درجة حرارة، مما يعني أنه يمتلك أقوى قوى ترابط (روابط هيدروجينية) وبالتالي أعلى درجة غليان.",
    level: 3,
