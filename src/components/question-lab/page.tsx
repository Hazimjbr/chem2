...
const newQuestion: Question | null = {
    questionText: (
        <>
            <p>اعتمادا على الرسم المجاور والذي يمثل العلاقة بين درجة الحرارة<span dir="ltr" className="inline-block">°C</span> والضغط البخاري mmHg لأربعة سوائل فإن الضغط البخاري لثنائي إيثيل إيثر C2H5OC2H5 عند<span dir="ltr" className="inline-block mx-1">30°C</span> يساوي</p>
    ...
    explanation: <>من خلال تتبع الخط العمودي من درجة حرارة<span dir="ltr" className="inline-block mx-1">30°C</span> حتى يتقاطع مع منحنى ثنائي إيثيل إيثر ثم التحرك أفقيًا إلى محور الضغط نجد أن القيمة تقارب 650mmHg</>,
    level: 2,
