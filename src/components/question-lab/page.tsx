...
const newQuestion: Question | null = {
    questionText: (
        <>
            <p>اعتمادا على الرسم المجاور والذي يمثل العلاقة بين درجة الحرارة <InlineMath math="^\circ\text{C}"/> والضغط البخاري mmHg لأربعة سوائل فإن الضغط البخاري لثنائي إيثيل إيثر C2H5OC2H5 عند <InlineMath math="30^\circ\text{C}"/> يساوي</p>
