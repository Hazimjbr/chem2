...
const newQuestion: Question | null = {
    questionText: (
        <>
            <span>وعاء حجمه </span>
            <span dir="ltr" className="inline-block mx-1"><InlineMath math="1.64L"/></span>
            <span> يحتوي على </span>
            <span dir="ltr" className="inline-block mx-1"><InlineMath math="1.1g"/></span>
            <span> من </span>
            <span dir="ltr" className="inline-block mx-1"><InlineMath math="CO_2"/></span>
            <span> و </span>
            <span dir="ltr" className="inline-block mx-1"><InlineMath math="1.6g"/></span>
            <span> من </span>
            ...
            <span dir="ltr" className="inline-block mx-1"><InlineMath math="C=12, N=14, O=16"/></span>
            <span>، فإن الضغوط الجزئية للغازات (</span>
            <span dir="ltr" className="inline-block mx-1"><InlineMath math="O_2 / CO_2"/></span>
    ...
    explanation: (
        <>
            <span>1. نحسب عدد مولات الغازات المعلومة:</span>
            <span dir="ltr" className="block text-left"><InlineMath math="n_{CO_2} = \frac{1.1g}{44g/mol} = 0.025 \text{ mol}"/></span>
            <span dir="ltr" className="block text-left"><InlineMath math="n_{O_2} = \frac{1.6g}{32g/mol} = 0.050 \text{ mol}"/></span>
            <span>2. نحسب عدد المولات الكلي من قانون الغاز المثالي:</span>
            <span dir="ltr" className="block text-left"><InlineMath math="n_{total} = \frac{PV}{RT} = \frac{1.5 \times 1.64}{0.0821 \times 300} \approx 0.1 \text{ mol}"/></span>
            <span>3. نحسب عدد مولات النيتروجين:</span>
            <span dir="ltr" className="block text-left"><InlineMath math="n_{N_2} = n_{total} - n_{CO_2} - n_{O_2} = 0.1 - 0.025 - 0.050 = 0.025 \text{ mol}"/></span>
            <span>4. نحسب الضغوط الجزئية باستخدام قانون دالتون (P_A = X_A \cdot P_{total}):</span>
            <span dir="ltr" className="block text-left"><InlineMath math="P_{CO_2} = \frac{0.025}{0.1} \times 1.5 = 0.375 \text{ atm}"/></span>
            <span dir="ltr" className="block text-left"><InlineMath math="P_{O_2} = \frac{0.050}{0.1} \times 1.5 = 0.750 \text{ atm}"/></span>
            <span>الترتيب المطلوب هو (O₂ / CO₂) أي (0.750 / 0.375).</span>
        </>
    ),
    level: 3,
