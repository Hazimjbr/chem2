...
export const elements: Element[] = [
  ...
  { name: 'لانثانيدات', symbol: '57-71', number: 57, atomic_mass: '', category: 'lanthanide', gridRow: 6, gridColumn: 3 },
  { name: 'هافنيوم', symbol: 'Hf', number: 72, atomic_mass: 178.49, category: 'transition-metal', gridRow: 6, gridColumn: 4 },
  { name: 'تنتالوم', symbol: 'Ta', number: 73, atomic_mass: 180.95, category: 'transition-metal', gridRow: 6, gridColumn: 5 },
  ...
  { name: 'بزموت', symbol: 'Bi', number: 83, atomic_mass: 208.98, category: 'post-transition-metal', gridRow: 6, gridColumn: 15 },
  { name: 'بولونيوم', symbol: 'Po', number: 84, atomic_mass: '(209)', category: 'metalloid', gridRow: 6, gridColumn: 16 },
  ...
  { name: 'أكتينيدات', symbol: '89-103', number: 89, atomic_mass: '', category: 'actinide', gridRow: 7, gridColumn: 3 },
  ...
  { name: 'مايتنريوم', symbol: 'Mt', number: 109, atomic_mass: '(276)', category: 'transition-metal', gridRow: 7, gridColumn: 9 },
  { name: 'دارمشتادتيوم', symbol: 'Ds', number: 110, atomic_mass: '(281)', category: 'transition-metal', gridRow: 7, gridColumn: 10 },
  { name: 'رونتجينيوم', symbol: 'Rg', number: 111, atomic_mass: '(280)', category: 'transition-metal', gridRow: 7, gridColumn: 11 },
